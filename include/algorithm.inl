...
namespace stdext
{
	...
	{
		return std::all_of(range::range_traits<InputRange>(&range, range.begin_pos()),
						   range::range_traits<InputRange>(&range, range.end_pos()),
						   pred);
	}
	...
	{
		return std::any_of(range::range_traits<InputRange>(&range, range.begin_pos()),
						   range::range_traits<InputRange>(&range, range.end_pos()),
						   pred);
	}
	...
	{
		return std::none_of(range::range_traits<InputRange>(&range, range.begin_pos()),
							range::range_traits<InputRange>(&range, range.end_pos()),
							pred);
	}
	...
	{
		return std::for_each(range::range_traits<InputRange>(&range, range.begin_pos()),
							 range::range_traits<InputRange>(&range, range.end_pos()),
							 f);
	}
	...
	{
		return std::find(range::range_traits<InputRange>(&range, range.begin_pos()),
						 range::range_traits<InputRange>(&range, range.end_pos()),
						 value).pos();
	}
	...
	{
		return std::find_if(range::range_iterator<InputRange>(range, range.begin_pos()),
							range::range_iterator<InputRange>(range, range.end_pos()),
							pred).pos();
	}
	...
	{
		return std::find_if_not(range::range_iterator<InputRange>(range, range.begin_pos()),
								range::range_iterator<InputRange>(range, range.end_pos()),
								pred).pos();
	}
	...
	{
		return std::find_end(range::range_iterator<ForwardRange1>(range1, range1.begin_pos()),
							 range::range_iterator<ForwardRange1>(range1, range1.end_pos()),
							 range::range_iterator<ForwardRange2>(range2, range2.begin_pos()),
							 range::range_iterator<ForwardRange2>(range2, range2.end_pos())).pos();
	}
	...
	typename range::range_traits<ForwardRange1>::position_type find_end(const ForwardRange1& range1, const ForwardRange2& range2, BinaryPredicate pred)
	{
		return std::find_end(range::range_iterator<ForwardRange1>(range1, range1.begin_pos()),
							 range::range_iterator<ForwardRange1>(range1, range1.end_pos()),
							 range::range_iterator<ForwardRange2>(range2, range2.begin_pos()),
							 range::range_iterator<ForwardRange2>(range2, range2.end_pos()),
							 pred).pos();
	}
	...
	{
		return std::find_first_of(range::range_iterator<InputRange>(range1, range1.begin_pos()),
								  range::range_iterator<InputRange>(range1, range1.end_pos()),
								  range::range_iterator<InputRange>(range2, range2.begin_pos()),
								  range::range_iterator<InputRange>(range2, range2.end_pos())).pos();
	}
	...
	typename range::range_traits<InputRange>::position_type find_first_of(const InputRange& range1, const ForwardRange& range2, BinaryPredicate pred)
	{
		return std::find_first_of(range::range_iterator<InputRange>(range1, range1.begin_pos()),
								  range::range_iterator<InputRange>(range1, range1.end_pos()),
								  range::range_iterator<InputRange>(range2, range2.begin_pos()),
								  range::range_iterator<InputRange>(range2, range2.end_pos()),
								  pred).pos();
	}
	...
	{
		return std::adjacent_find(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								  range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		return std::adjacent_find(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								  range::range_iterator<ForwardRange>(range, range.end_pos()),
								  pred).pos();
	}

	template<class InputRange, class T>
	typename range::range_traits<InputRange>::difference_type count(const InputRange& range, const T& value)
	{
		return std::count(range::range_iterator<InputRange>(range, range.begin_pos()),
						  range::range_iterator<InputRange>(range, range.end_pos()),
						  value);
	}

	template<class InputRange, class Predicate>
	typename range::range_traits<InputRange>::difference_type count_if(const InputRange& range, Predicate pred)
	{
		return std::count_if(range::range_iterator<InputRange>(range, range.begin_pos()),
							 range::range_iterator<InputRange>(range, range.end_pos()),
							 pred);
	}
	...
	{
		auto std_r = std::mismatch(range::range_iterator<InputRange>(range1, range1.begin_pos()),
								   range::range_iterator<InputRange>(range1, range1.end_pos()),
								   first2);
	...
	{
		return std::equal(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
						  range::range_iterator<InputRange1>(range1, range1.end_pos()),
						  first2);
	}
	...
	{
		return std::equal(range::range_iterator<InputRange1>(range, range1.begin_pos()),
						  range::range_iterator<InputRange1>(range, range1.end_pos()),
						  first2, pred);
	}
	...
	{
		return std::is_permutation(range::range_iterator<ForwardRange1>(range1, range1.begin_pos()),
								   range::range_iterator<ForwardRange1>(range1, range1.end_pos()),
								   first2);
	}
	...
	{
		if (range::length(range1) != range::length(range2))
			return false;
	...
	{
		return std::search(range::range_iterator<ForwardRange1>(range1, range1.begin_pos()),
						   range::range_iterator<ForwardRange1>(range1, range1.end_pos()),
						   range::range_iterator<ForwardRange2>(range2, range2.begin_pos()),
						   range::range_iterator<ForwardRange2>(range2, range2.end_pos())).pos();
	}
	...
	{
		return std::search_n(range::range_iterator<ForwardRange>(range, range.begin_pos()),
							 range::range_iterator<ForwardRange>(range, range.end_pos()),
							 count, value).pos();
	}
	...
	{
		return std::copy(range::range_iterator<InputRange>(range, range.begin_pos()),
						 range::range_iterator<InputRange>(range, range.end_pos()),
						 result);
	}
	...
	{
		return std::copy_n(range::range_iterator<InputRange>(range, range.begin_pos()),
						   n, result);
	}
	...
	{
		return std::copy_if(range::range_iterator<InputRange>(range, range.begin_pos()),
							range::range_iterator<InputRange>(range, range.end_pos()),
							result, pred);
	}
	...
	{
		return std::copy_backward(range::range_iterator<BidirectionalRange1>(range, range.begin_pos()),
								  range::range_iterator<BidirectionalRange1>(range, range.end_pos()),
								  result);
	}
	...
	{
		return std::move(range::range_iterator<InputRange>(range, range.begin_pos()),
						 range::range_iterator<InputRange>(range, range.end_pos()),
						 result);
	}
	...
	{
		return std::move_backward(range::range_iterator<BidirectionalRange1>(range, range.begin_pos()),
								  range::range_iterator<BidirectionalRange1>(range, range.end_pos()),
								  result);
	}
	...
	{
		return std::swap_ranges(range::range_iterator<ForwardRange1>(range1, range1.begin_pos()),
								range::range_iterator<ForwardRange1>(range1, range1.end_pos()),
								first2);
	}
	...
	{
		return std::transform(range::range_iterator<InputRange>(range, range.begin_pos()),
							  range::range_iterator<InputRange>(range, range.end_pos()),
							  result, op);
	}
	...
	{
		return std::transform(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
							  range::range_iterator<InputRange1>(range1, range1.end_pos()),
	...
	{
		std::replace(range::range_iterator<ForwardRange>(range, range.begin_pos()),
					 range::range_iterator<ForwardRange>(range, range.end_pos()),
					 old_value, new_value);
	}
	...
	{
		std::replace_if(range::range_iterator<ForwardRange>(range, range.begin_pos()),
						range::range_iterator<ForwardRange>(range, range.end_pos()),
						pred, new_value);
	}
	...
	{
		return std::replace_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
								 range::range_iterator<InputRange>(range, range.end_pos()),
	...
	{
		return std::replace_copy_if(range::range_iterator<InputRange>(range, range.begin_pos()),
									range::range_iterator<InputRange>(range, range.end_pos()),
	...
	{
		std::fill(range::range_iterator<ForwardRange>(range, range.begin_pos()),
				  range::range_iterator<ForwardRange>(range, range.end_pos()),
				  value);
	}
	...
	{
		return std::fill_n(range::range_iterator<OutputRange>(range, range.begin_pos()),
						   n, value);
	}
	...
	{
		std::generate(range::range_iterator<ForwardRange>(range, range.begin_pos()),
					  range::range_iterator<ForwardRange>(range, range.end_pos()),
					  gen);
	}
	...
	{
		return std::generate_n(range::range_iterator<OutputRange>(range, range.begin_pos()),
							   n, gen).pos();
	}
	...
	{
		return std::remove(range::range_iterator<ForwardRange>(range, range.begin_pos()),
						   range::range_iterator<ForwardRange>(range, range.end_pos()),
						   value).pos();
	}
	...
	{
		return std::remove_if(range::range_iterator<ForwardRange>(range, range.begin_pos()),
							  range::range_iterator<ForwardRange>(range, range.end_pos()),
							  pred).pos();
	}
	...
	{
		return std::remove_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
								range::range_iterator<InputRange>(range, rane.end_pos()),
								result, value);
	}
	...
	{
		return std::remove_copy_if(range::range_iterator<InputRange>(range, range.begin_pos()),
								   range::range_iterator<InputRange>(range, range.end_pos()),
								   result, pred);
	}
	...
	{
		return std::unique(range::range_iterator<ForwardRange>(range, range.begin_pos()),
						   range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		return std::unique_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
								range::range_iterator<InputRange>(range, range.end_pos()),
								result);
	}
	...
	{
		std::reverse(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
					 range::range_iterator<BidirectionalRange>(range, range.end_pos()));
	}

	template<class BidirectionalRange, class OutputIterator>
	OutputIterator reverse_copy(const BidirectionalRange& range, OutputIterator result)
	{
		return std::reverse_copy(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
								 range::range_iterator<BidirectionalRange>(range, range.end_pos()),
								 result);
	}
	...
	{
		return std::rotate(range::range_iterator<ForwardRange>(range, range.begin_pos()),
						   range::range_iterator<ForwardRange>(range, middle),
						   range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		return std::rotate_copy(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								range::range_iterator<ForwardRange>(range, middle),
								range::range_iterator<ForwardRange>(range, range.end_pos()),
								result);
	}
	...
	{
		std::random_shuffle(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
							range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::shuffle(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
					 range::range_iterator<RandomAccessRange>(range, range.end_pos()),
	...
	{
		return std::is_partitioned(range::range_iterator<InputRange>(range, range.begin_pos()),
								   range::range_iterator<InputRange>(range, range.end_pos()),
								   pred);
	}
	...
	{
		return std::partition(range::range_iterator<ForwardRange>(range, range.begin_pos()),
							  range::range_iterator<ForwardRange>(range, range.end_pos()),
							  pred).pos();
	}
	...
	{
		return std::stable_partition(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
									 range::range_iterator<BidirectionalRange>(range, range.end_pos()),
									 pred).pos();
	}
	...
	{
		return std::partition_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
									range::range_iterator<InputRange>(range, range.end_pos()),
	...
	{
		return std::partition_point(range::range_iterator<ForwardRange>(range, range.begin_pos()),
									range::range_iterator<ForwardRange>(range, range.end_pos()),
									pred).pos();
	}
	...
	{
		std::sort(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
				  range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::stable_sort(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
						 range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::partial_sort(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
						  range::range_iterator<RandomAccessRange>(range, middle),
						  range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	typename range::range_traits<RandomAccessRange>::position_type partial_sort_copy(const InputRange& range, RandomAccessRange result_range)
	{
		return std::partial_sort_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
									  range::range_iterator<InputRange>(range, range.end_pos()),
									  range::range_iterator<RandomAccessRange>(result_range, result_range.begin_pos()),
									  range::range_iterator<RandomAccessRange>(result_range, result_range.end_pos())).pos();
	}

	template<class InputRange, class RandomAccessRange, class Compare>
	typename range::range_traits<RandomAccessRange>::position_type partial_sort_copy(const InputRange& range, RandomAccessRange result_range, Compare comp)
	{
		return std::partial_sort_copy(range::range_iterator<InputRange>(range, range.begin_pos()),
									  range::range_iterator<InputRange>(range, range.end_pos()),
									  range::range_iterator<RandomAccessRange>(result_range, result_range.begin_pos()),
									  range::range_iterator<RandomAccessRange>(result_range, result_range.end_pos()),
									  comp).pos();
	}
	...
	{
		return std::is_sorted(range::range_iterator<ForwardRange>(range, range.begin_pos()),
							  range::range_iterator<ForwardRange>(range, range.end_pos()));
	}
	...
	{
		return std::is_sorted_until(range::range_iterator<ForwardRange>(range, range.begin_pos()),
									range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		std::nth_element(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
						 range::range_iterator<RandomAccessRange>(range, nth),
						 range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		return std::lower_bound(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								range::range_iterator<ForwardRange>(range, range.end_pos()),
								value).pos();
	}
	...
	{
		return std::upper_bound(range::range_traits<ForwardRange>(&range, range.begin_pos()),
								range::range_traits<ForwardRange>(&range, range.end_pos()),
								value).pos();
	}
	...
	{
		auto positions = std::equal_range(range::range_iterator<ForwardRange>(range, range.begin_pos()),
										  range::range_iterator<ForwardRange>(range, range.end_pos()),
										  value);
	...
	{
		return std::binary_search(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								  range::range_iterator<ForwardRange>(range, range.end_pos()),
								  value);
	}
	...
	{
		return std::merge(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
						  range::range_iterator<InputRange1>(range1, range1.end_pos()),
						  range::range_iterator<InputRange2>(range2, range2.begin_pos()),
						  range::range_iterator<InputRange2>(range2, range2.end_pos()),
						  result);
	}
	...
	{
		std::inplace_merge(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
						   range::range_iterator<BidirectionalRange>(range, middle),
						   range::range_iterator<BidirectionalRange>(range, range.end_pos()));
	}
	...
	{
		return std::includes(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
							 range::range_iterator<InputRange1>(range1, range1.end_pos()),
							 range::range_iterator<InputRange2>(range2, range2.begin_pos()),
							 range::range_iterator<InputRange2>(range2, range2.end_pos()));
	}
	...
	{
		return std::set_union(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
							  range::range_iterator<InputRange1>(range1, range1.end_pos()),
							  range::range_iterator<InputRange2>(range2, range2.begin_pos()),
							  range::range_iterator<InputRange2>(range2, range2.end_pos()),
							  result);
	...
	{
		return std::set_intersection(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
									 range::range_iterator<InputRange1>(range1, range1.end_pos()),
									 range::range_iterator<InputRange2>(range2, range2.begin_pos()),
									 range::range_iterator<InputRange2>(range2, range2.end_pos()),
									 result);
	...
	{
		return std::set_difference(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
								   range::range_iterator<InputRange1>(range1, range1.end_pos()),
								   range::range_iterator<InputRange2>(range2, range2.begin_pos()),
								   range::range_iterator<InputRange2>(range2, range2.end_pos()),
								   result);
	...
	{
		return std::set_symmetric_difference(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
											 range::range_iterator<InputRange1>(range1, range1.end_pos()),
											 range::range_iterator<InputRange2>(range2, range2.begin_pos()),
											 range::range_iterator<InputRange2>(range2, range2.end_pos()),
											 result);
	...
	{
		std::push_heap(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
					   range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::pop_heap(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
					  range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::make_heap(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
					   range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		std::sort_heap(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
					   range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		return std::is_heap(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
							range::range_iterator<RandomAccessRange>(range, range.end_pos()));
	}
	...
	{
		return std::is_heap_until(range::range_iterator<RandomAccessRange>(range, range.begin_pos()),
								  range::range_iterator<RandomAccessRange>(range, range.end_pos())).pos();
	}
	...
	{
		return std::min_element(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		return std::max_element(range::range_iterator<ForwardRange>(range, range.begin_pos()),
								range::range_iterator<ForwardRange>(range, range.end_pos())).pos();
	}
	...
	{
		auto positions = std::minmax_element(range::range_iterator<ForwardRange>(range, range.begin_pos()),
											 range::range_iterator<ForwardRange>(range, range.end_pos()));
	...
	{
		return std::lexicographical_compare(range::range_iterator<InputRange1>(range1, range1.begin_pos()),
											range::range_iterator<InputRange1>(range1, range1.end_pos()),
											range::range_iterator<InputRange2>(range2, range2.begin_pos()),
											range::range_iterator<InputRange2>(range2, range2.end_pos()));
	}
	...
	{
		return std::next_permutation(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
									 range::range_iterator<BidirectionalRange>(range, range.end_pos()));
	}
	...
	{
		return std::prev_permutation(range::range_iterator<BidirectionalRange>(range, range.begin_pos()),
									 range::range_iterator<BidirectionalRange>(range, range.end_pos()));
	}
